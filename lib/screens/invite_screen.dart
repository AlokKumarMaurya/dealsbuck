    ...
    return SafeArea(
      ...
      body: Column(
        children: [
          ...
          Text("Refer your friends to DealsBuck & earn 199 coins",
              style: TextStyle(
          ...
          Padding(
            ...
            child: Text(
              "You will get 199 coins in your wallet when your friends will purchase membership with your referral code",
              style: TextStyle(
                fontSize: 11,
              ),
              maxLines: 2,
