...
ParticularCategoryList particularCategoryListFromJson(String str) =>
    ParticularCategoryList.fromJson(json.decode(str));

String particularCategoryListToJson(ParticularCategoryList data) =>
...
class ParticularCategoryList {
  ...
  factory ParticularCategoryList.fromJson(Map<String, dynamic> json) =>
      ParticularCategoryList(
        status: json["status"],
